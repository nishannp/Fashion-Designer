...
const REMIX_IDEAS = [
    "to find a wedding guest dress.",
    "to create professional work looks.",
    "to try on vintage fashion styles.",
    "to explore different seasonal outfits.",
    "to design a new formal outfit.",
    "to create a casual weekend look.",
];
